...
- financial, transaction, fraud-prevention or other records that a law requires or
  reasonably allows us to retain (we restrict access to any such records and delete
  them when the required period ends);
