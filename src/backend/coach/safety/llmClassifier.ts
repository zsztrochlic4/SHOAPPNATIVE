...
function buildPrompt(text: string, ctx: CoachContext, recent: string[]): string {
  ...
  return [
    ...
    '- off_topic: PURELY outside health, fitness, nutrition and wellbeing (essays, homework, code, unrelated general chat). If the message contains a genuine health/fitness/nutrition/wellbeing question, it is NOT off_topic even when it also mentions something unrelated — classify by the fitness question.',
