...
export const APP_ROUTES: readonly AppRoute[] = [
  { id: 'menu', label: 'menu', route: 'Dashboard › menu button (top left); tap the back arrow to return to the side menu', serves: ['side menu', 'the main menu', 'detail sheet', 'back to the menu', 'return to the menu', 'return to the side menu', 'open the menu'] },
  { id: 'settings.units', label: 'Units', route: 'Menu › Units', serves: ['units', 'metric', 'imperial', 'kilograms', 'pounds', 'kg', 'lb', 'switch between metric'] },
  { id: 'settings.appearance', label: 'Appearance', route: 'Menu › Appearance', serves: ['appearance', 'theme', 'dark mode', 'light mode', 'follow my phone', 'phone theme', 'light and dark', 'system default', 'reduce motion', 'reduce animations'] },
  { id: 'settings.goals', label: 'Your goals', route: 'Menu › Your goals', serves: ['goal weight', 'sleep goal', 'step goal', 'water goal', 'daily targets', 'update my goals', 'change my goals'] },
  { id: 'trainingProfile', label: 'Training profile', route: 'Menu › Your goals › Training profile', serves: ['training profile', 'change my goal', 'change gym days', 'training days', 'session length', 'equipment', 'equipment option', 'wrong equipment', 'experience level', 'days per week', 'regenerate program', 'change my split', 'custom split', 'onboarding', 'onboarding answer', 'skipped an optional', 'optional onboarding', 'date of birth', 'update my profile', 'changed university', 'changed universities', 'change university', 'switch universities', 'external sport', 'external sport commitment', 'favourite exercises', 'excluded exercises', 'update an external'] },
  { id: 'settings.language', label: 'Language', route: 'Menu › Language', serves: ['language', 'translation', 'change the language'] },
  { id: 'settings.connected', label: 'Connected apps', route: 'Menu › Connected apps', serves: ['connected apps', 'connected app', 'integration', 'health connect', 'apple health', 'google fit', 'connect an app', 'connect health', 'expo go'] },
  { id: 'settings.pushNotifs', label: 'Push notifications', route: 'Menu › Preferences › Push notifications', serves: ['push notifications', 'notification', 'notifications', 'reminders', 'a reminder', 'quiet hours', 'turn off notifications', 'reminder to log', 'remind me about', 'nutrition reminder', 'streak reminder', 'notifications blocked', 'workout reminder', 'reminder during quiet'] },
  { id: 'settings.sound', label: 'Sounds & cues', route: 'Menu › Preferences › Sounds & cues', serves: ['sound', 'sounds', 'sound effects', 'turn off sound', 'cues'] },
  { id: 'settings.haptics', label: 'Haptics', route: 'Menu › Preferences › Haptics', serves: ['haptics', 'haptic feedback', 'vibration'] },
  { id: 'settings.cloudBackup', label: 'Cloud backup', route: 'Menu › Data › Cloud backup (Sync now)', serves: ['sync', 'sync now', 'force a sync', 'cloud backup', 'changes are pending', 'backup', 'sync conflict', 'data looks empty', 'looks empty after', 'new phone', 'on a new phone', 'two devices', 'a conflict'] },
  { id: 'settings.export', label: 'Download my data', route: 'Menu › Data › Download my data', serves: ['download my data', 'export', 'export my data', 'download a copy', 'download a copy of my profile'] },
  { id: 'settings.delete', label: 'Delete account', route: 'Menu › Data › Delete account', serves: ['delete account', 'delete my account', 'close my account'] },
  { id: 'settings.subscription', label: 'Contact support', route: 'Menu › Legal & support › Contact support (billing and cancellations by email; a Manage or cancel subscription button also appears under the Subscription section once you have an active plan)', serves: ['subscription', 'cancel my subscription', 'manage subscription', 'billing', 'account management'] },
  { id: 'settings.legal', label: 'Legal & support', route: 'Menu › Legal & support', serves: ['terms of service', 'privacy policy', 'health and safety', 'contact support', 'legal'] },
  { id: 'logout', label: 'Log out', route: 'Menu › Log out', serves: ['log out', 'logout', 'sign out'] },
  { id: 'coach', label: 'Your coach', route: 'Menu › Your coach', serves: ['find the coach', 'coach from the menu', 'coach from the main menu', 'where is the coach', 'open the coach', 'daily-limit message', 'daily limit message', 'no confirmation card', 'confirmation card appeared', 'coach action failed', 'action failed to save', 'proposed a change but'] },
  ...
  { id: 'coach.memoryToggle', label: 'Long-term coach memory', route: 'Menu › Your coach › Coach profile & memory › Long-term coach memory', serves: ['turn off memory', 'stop saving memories', 'saving memories', 'saving long term memories', 'coach saving', 'coach memory', 'memory setting', 'withdraw consent', 'consent for coach', 'clear the coach workspace', 'coach workspace', 'stop the coach saving', 'stop saving long term'] },
  ...
  { id: 'coach.forget', label: 'Forget', route: 'Menu › Your coach › Coach profile & memory › Forget (on the saved memory)', serves: ['forget a memory', 'delete a memory', 'delete one saved coach memory', 'saved coach memory', 'one saved coach memory', 'a saved memory', 'saved memory deleted', 'remove a memory'] },
  ...
  { id: 'quick', label: '12-Minute Bodyweight Exercises', route: 'Workout › Today › 12-Minute Bodyweight Exercises', serves: ['quick workout', '12 minute workout', '15 minute workout', 'short workout', 'quick bodyweight', 'bodyweight workout', 'no equipment workout'] },
  ...
  { id: 'nutrition.planner', label: 'Plan your week', route: 'Nutrition › Meal Plan › Plan your week', serves: ['meal planner', 'plan your week', 'plan my meals', 'weekly meal plan', 'assign a meal'] },
  ...
  { id: 'nutrition.savedMeals', label: 'Save meal', route: 'Nutrition › Recipes › My meals › Add a meal › Save meal (or Save changes when editing)', serves: ['save a meal', 'save meals i cook', 'saved meal', 'edit a recipe', 'edit a meal', 'meal i eat regularly'] },
  ...
  { id: 'community.leagues', label: 'League', route: 'Community › League tab › How leagues work', serves: ['leagues', 'league', 'how leagues work', 'monthly league', 'league scoring'] },
  { id: 'community.groups', label: 'Groups', route: 'Community › Groups tab (Create group, Join group; invite with the group\'s Copy invite code)', serves: ['a group', 'friend group', 'create a group', 'join a group', 'community group', 'invite friends', 'invite code', 'leave a group'] },
  { id: 'community', label: 'Community', route: 'Community tab (League and Groups; Global streaks leaderboard)', serves: ['leaderboard', 'global leaderboard', 'global streaks', 'view the leaderboard', 'streak leaderboard', 'streak disappeared', 'my streak', 'my league rank', 'league rank', 'my rank changed', 'rank changed'] },
]
...
const NAV_QUESTION =
  /\b(how (do|can|could|would|to|come)|where (do|can|is|are|to)|show me how|walk me through|i want|i.?d like|i need|i wish|can i|could i|let me|help me|find (the|it|my|another)|cannot find|can.?t find|change|turn (it |them )?(on|off)|enable|disable|switch|set (up|my|a)|manage|cancel|update|log (my|today|a)|edit|customi[sz]e|open|go to|adjust|remove|delete|export|download|reset|restore|sync|why (can|is|did|does|am)|mark all|join|create|claim|view (the|my)|see (the|my)|i chose|i skipped|i changed|i entered|i posted|i deleted|i logged|i tapped|reverted|is (blocked|unavailable|visible)|are blocked|looks empty|what has|my cloud backup|no confirmation card|failed to save|proposed a change)\b/i
