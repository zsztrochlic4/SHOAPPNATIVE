...
export const APP_ROUTES: readonly AppRoute[] = [
  ...
  { id: 'settings.cloudBackup', label: 'Cloud backup', route: 'Menu › Settings › Cloud backup (Sync now)', serves: ['sync', 'sync now', 'force a sync', 'cloud backup', 'changes are pending', 'backup', 'sync conflict', 'data looks empty', 'looks empty after', 'new phone', 'on a new phone', 'two devices', 'a conflict'] },
  ...
  { id: 'coach.memoryToggle', label: 'Memory', route: 'Menu › Your coach › Coach profile & memory › Memory', serves: ['turn off memory', 'stop saving memories', 'saving memories', 'saving long term memories', 'coach saving', 'coach memory', 'memory setting', 'withdraw consent', 'consent for coach', 'clear the coach workspace', 'coach workspace', 'stop the coach saving', 'stop saving long term'] },
  ...
  { id: 'community', label: 'Community', route: 'Community tab', serves: ['leaderboard', 'global leaderboard', 'view the leaderboard', 'community scope', 'campus', 'dorm', 'society', 'wrong community scope', 'wrong scope', 'kudos', 'likes', 'comments', 'bookmarks', 'how kudos', 'share a personal record', 'personal record with the community', 'with the community', 'share a pr', 'post a pr', 'share with the community', 'a challenge', 'join a challenge', 'streak disappeared', 'my streak', 'difference between campus', 'my league rank', 'league rank', 'my rank changed', 'rank changed', 'posted something to the wrong'] },
]
