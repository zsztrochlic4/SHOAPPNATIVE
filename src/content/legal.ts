...
const TERMS: LegalDoc = {
  ...
  blocks: [
    ...
    { p: `You may stop using the Service, cancel a subscription and request account deletion at any time. Deleting the app does not cancel a subscription or delete your account.` },
