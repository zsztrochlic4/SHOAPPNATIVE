...
export function buildPrompt(text, recent = [], exemplars = []) {
  ...
  return [
    ...
    '- off_topic: PURELY not fitness/nutrition/wellbeing (essays, homework, code, general chat). If the message contains a genuine health/fitness/nutrition/wellbeing question, it is NOT off_topic even when it also mentions something unrelated — classify by the fitness question.',
